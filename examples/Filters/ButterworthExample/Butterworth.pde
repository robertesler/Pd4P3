...
class Butterworth {
  ...
  double oversample = 1; //We will use this later when we are up or down sampling
  ...
  public Butterworth(double lop, double hip, double normal)
  {
  ...
  void setOversample(double over)
  {
    oversample = over;
  }
