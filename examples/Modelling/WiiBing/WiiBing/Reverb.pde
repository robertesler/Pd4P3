...
I stole this from the ReverbDemo.pde example in Pd4P3
*/
class Reverb {
...
public double perform(double input) {
    ...
    del1 =  delay1.perform(142) + input;
    delay2.delayWrite(del2 * gain2);
    del2 =  delay2.perform(167) + input;
    delay3.delayWrite(del3 * gain3);
    del3 =  delay3.perform(198) + input;
    delay4.delayWrite(del4 * gain4);
    del4 =  delay2.perform(206) + input;
